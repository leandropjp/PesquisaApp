...
class AppConfig: NSObject {
    ...
    var questions = [Question(dict: question1) ,Question(dict: question2), Question(dict: question3), Question(dict: question4), Question(dict: question5), Question(dict: question6),
                     ...
                     Question(dict: question30),Question(dict: question31),Question(dict: question32),Question(dict: question33),Question(dict: question34)]
    var questionsCount = 0
    
    var answers = [Answer](repeating: Answer(), count: 34)
    
    var progressBarValue: CGFloat = 0
    
    var progressNotification = [1, 11, 18, 25, 34]
...
let question21: [String: Any] = ["question": "Sua empresa utiliza a Matriz Swot? ",
                                 "answers": ["Sim(Radio)", "Não(Radio)"]]

let question22: [String: Any] = ["question": "Sua empresa utiliza indicadores de gestão?",
                                 "answers": ["Sim(Radio)(Comment)(if)", "Não (Radio)"]]
//if "sim" exibir (TextBox) "Poderia citar alguns?"

let question23: [String: Any] = ["question": "Mudanças de estratégia são comuns em sua empresa?",
                                 "answers": ["Sim(Radio)", "Não(Radio)"]]
    
let question24: [String: Any] = ["question": "Você considera que as mudanças no ambiente externo impactam no planejamento da empresa em qual nível?",
...
let question25: [String: Any] = ["question": "Você considera que mudanças na sua empresa são rápidas e eficazes conforme muda o mercado?",
                                 "answers": ["Sim(Radio)", "Não(Radio)"]]

let question26: [String: Any] = ["question": "Você considera que sua empresa domina e entende o comportamento de compra de seu cliente?",
                                 "answers": ["Sim(Radio)", "Não(Radio)"]]
    
let question27: [String: Any] = ["question": "Você acredita que os conceitos da neurociência podem ser aplicados na gestão empresarial?",
                                 "answers": ["Sim(Radio)(Comment)(if)", "Não(Radio)"]]
//if "sim" exibir (TextBox) "Comentário"

let question28: [String: Any] = ["question": "Você já ouviu falar em Neuromarketing?",
                                 "answers": [" Sim, conheço e aplico(Radio)", "Sim, mas não sei do que se trata(Radio)","Não ouvi falar(Radio)"]]
    
let question29: [String: Any] = ["question": "Você já ouviu falar em Neuroeconomia?",
                                 "answers": ["Sim(Radio)(Comment)(if)", "Não(Radio)"]]
//if "sim" exibir (TextBox) "Comentário"

let question30: [String: Any] = ["question": "Você já ouviu falar no termo Neuroestratégia?",
                                 "answers": ["Sim(Radio)(Comment)(if)", "Não(Radio)"]]
//if "sim" exibir (TextBox) "Comentário"

let question31: [String: Any] = ["question": "Você já ouviu falar em ancoragem de preços?",
                                 "answers": ["Sim(Radio)(Comment)(if)", "Não(Radio)"]]
//if "sim" exibir (TextBox) "Comentário"
let question32: [String: Any] = ["question": "O que você acha mais relevante para o seu cliente?",
                                 "answers": ["Preço(Radio)", "Experiência (Radio)"]]

let question33: [String: Any] = ["question": "Você utiliza marketing sensorial na sua organização?",
                                 "answers": ["Sim(Radio)(Comment)(if)", "Não(Radio)", "Desconheço(Radio)"]]
//if "sim" exibir (TextBox) "Comentário"
let question34: [String: Any] = ["question": "Você acha que a neurociência aplicada na sua organização pode contribuir para o sucesso da gestão?",
                                 "answers": ["Sim(Radio)", "Não(Radio)"]]
